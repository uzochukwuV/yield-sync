...
contract WeatherInsurance is FunctionsClient, AutomationCompatibleInterface, Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Manual claim processing function for external calls
     */
     ...
     * @param _policyId Policy ID to claim payout for
     */
    ...
    /**
     * @notice Get weather risk history for a station
     * @param _stationId Station ID
     * @return riskData Array of weather risk data
     */
    function getStationWeatherHistory(string memory _stationId) external view returns (WeatherRiskData[] memory) {
        return s_stationWeatherHistory[_stationId];
    }
